            ...
            <form action="submitlogin.php" method="post">
              <div class="container1">
                <div class="field input-field mail-field">
                  ...
                  <!--<span class="Error">
                    <img src="error.png" height="15px" width="15px">
                    <p class="errortext">Please enter a valid email</p>
                  </span>-->
              ...
              <div class="container1">
                ...
                <span id="errorMessage" class="Error" style="display: flex;flex-direction: row;margin-top: 5px;">
                  <img src="images\error.png" height="15px" width="15px" >
                  <p class="errortext" style="color: red;font-size: 1rem;margin-left: 5px;">Please enter a valid email and password.</p>
              </span>
              </div>
