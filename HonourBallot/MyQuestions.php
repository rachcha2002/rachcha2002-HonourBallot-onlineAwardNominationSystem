...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="MyQuestions.css">
...
<body>
  ...
  <div class="heropart">
    <div class="quote">
      <h3>Already Asked?</h3>
      <p>Find out if your question has been answered</p>
    </div>
    <div class="search">
      <form action="MyQuestions.php" method="get">
...
<section class="section-1" id="sec1">
  ...
  if (isset($_GET['search_data'])) {
    ...
    $sql = "SELECT * FROM userquestion WHERE userName = '$username' AND question LIKE '%$searchTerm%'";
  } else {
    $sql = "SELECT * FROM userquestion WHERE userName = '$username'";
  }
