<html>
<head>
    <title>Admin Honour Ballot Add Awards</title>
...
<body>
  ...
  <h2 class="title">Add New Awards</h2>
  <div class="heropart">
    <div class="quote">
      <h3>Proper Award True Artist</h3>
    </div>
...
<center>
    <div class="addform">
            ...
            <form action='submitAddFAwards.php' method="post">
                 
                </br>
                <input type="text" name="field1" placeholder="Award Name" required>
                </br>
               
                <br>
                <textarea name="field2" rows="8" cols="50" Placeholder="Awards Description" required></textarea>
                <br>
