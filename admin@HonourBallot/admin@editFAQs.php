...
<body>
  ...
  <h2 class="title">Upadate FAQ Answers</h2>
  <div class="heropart">
    <div class="quote">
...
<form action="submitUpdateFAQs.php" method="GET" name="form2" class="addform">
        <table border="0" width="25%">
            ...
            <tr>
                <td>Question</td>
                <td><input type="text" value="<?php echo $U_questionn ?>" name="field1"></td>
            </tr>
            <tr>
                <td>Answer</td>
                <td><textarea name="field2" rows="20" colums="100"><?php echo $answer ?></textarea></td>
