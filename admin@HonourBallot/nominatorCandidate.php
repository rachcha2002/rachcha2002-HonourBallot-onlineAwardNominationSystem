<html>
<head>
    <title>Nominator Honour Ballot Candidate</title>
...
<body>
  ...
  <div class="heropart">
    <div class="quote">
      <h3>Make the candidates' profile elegent</h3>
    </div>
...
<br>
<button class="addbtn"><a href="nominator@addCandidates.php">Add Candidates</a></button>
<br>  
...
<div class="questions tbl" style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5);width:80%;">
    <table border="1">
    <tr>
        <th class="col1">Candidate Id</th>
        <th class="col2" >Candidate Name</th>
   ...
   if ($result->num_rows > 0) { 
    while ($row = $result->fetch_assoc()) {
        echo "<tr><td>".$row["CID"]."</td><td style='text-align:left'>".$row["cName"]."</td><td style='text-align:left'>".$row["cDes"]."</td>";
        echo "<td><a href='nominator@editCandidates.php?id=".$row["CID"]."&name=".$row["cName"]."&des=".$row["cDes"]."'>Update<span><img src='edit.png' height='25px' width='25px' style='margin-left:5px;'></span></a></td>";

        echo "<td><a href='deleteCandidates.php?id=".$row["CID"]."'>Delete<span><img src='bin.png' height='22px' width='22px' style='margin-left:5px;'></span></a></td></tr>";
    }
   } else {
