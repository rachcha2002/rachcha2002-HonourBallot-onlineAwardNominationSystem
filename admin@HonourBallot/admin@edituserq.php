...
<body>
  ...
  <h2 class="title">Upadate Answers</h2>
  <div class="heropart">
    <div class="quote">
...
<form action="submitUpdateQ&A.php" method="GET" name="form2">
        <table border="0" width="25%">
            ...
            <tr>
                <td>User Name</td>
                <td><input type="text" value="<?php echo $U_name ?>" name="field1" readonly></td>
            </tr>
            <tr>
                <td>Question</td>
                <td><input type="text" value="<?php echo $U_questionn ?>" name="field2" readonly></td>
            </tr>
            <tr>
                <td>Answer</td>
                <td><textarea name="field3"><?php echo $answer ?></textarea></td>
