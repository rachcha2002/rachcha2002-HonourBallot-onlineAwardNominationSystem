<html>
<head>
    <title>Admin Honour Ballot</title>
...
<body>
  ...
  <div class="heropart">
    <div class="quote">
      <h3>Make a prominent appreciation</h3>
    </div>
...
<br>
<button class="addbtn"><a href="admin@addAwards.php">Add Awards</a></button>
<br>  
...
<div class="questions tbl" style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5);width:80%;">
    <table border="1">
    <tr>
        <th class="col1">Award Id</th>
        <th class="col2" >Award Name</th>
   ...
   if ($result->num_rows > 0) { 
    while ($row = $result->fetch_assoc()) {
        echo "<tr><td>".$row["AwardID"]."</td><td style='text-align:left'>".$row["awardName"]."</td><td style='text-align:left'>".$row["awardDes"]."</td>";
        echo "<td><a href='admin@editAwards.php?id=".$row["AwardID"]."&name=".$row["awardName"]."&des=".$row["awardDes"]."'>Update<span><img src='edit.png' height='25px' width='25px' style='margin-left:5px;'></span></a></td>";

        echo "<td><a href='deleteAwards.php?id=".$row["AwardID"]."'>Delete<span><img src='bin.png' height='22px' width='22px' style='margin-left:5px;'></span></a></td></tr>";
    }
   } else {
