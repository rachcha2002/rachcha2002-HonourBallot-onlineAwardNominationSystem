<html>
<head>
    <title>Nominator Honour Ballot Add Candidates</title>
...
<body>
  ...
  <h2 class="title">Add New Candidates</h2>
  <div class="heropart">
    <div class="quote">
      <h3>Make new oppertunity for a true artist</h3>
    </div>
...
<center>
    <div class="addform">
            ...
            <form action='submitAddCandidates.php' method="post">
                 
                </br>
                <input type="text" name="field1" placeholder="Candidate Name" required>
                </br>
               
                <br>
                <textarea name="field2" rows="8" cols="50" Placeholder="Candidate Description" required></textarea>
                <br>
